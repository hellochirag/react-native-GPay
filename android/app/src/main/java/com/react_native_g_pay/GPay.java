...
public class GPay extends ReactContextBaseJavaModule {
    ...
    private static JSONObject getCardPaymentMethod(ReadableMap cardPaymentMethodMap) throws JSONException {
        ...
        cardPaymentMethod.put("tokenizationSpecification", GPay.getTokenizationSpecification(cardPaymentMethodMap.getMap("gateway")));
    ...
    private static JSONObject getPaymentDataRequest(ReadableMap requestData) {
        try {
            ...
            paymentDataRequest.put(
                    "allowedPaymentMethods", new JSONArray().put(GPay.getCardPaymentMethod(requestData.getMap("cardPaymentMethodMap"))));
